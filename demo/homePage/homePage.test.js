...
// doApi middleware function - global API call should be added by app (res.guar.renderDataglobalNav)
// preData and postData middlware functions - res.guar.renderDataglobalNav.deviceType should be added
