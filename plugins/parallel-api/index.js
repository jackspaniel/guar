...
// 2. A config object which is merged with the guar config properties

var _ = require('lodash');

module.exports = function(app, config) {
  var debug = config.customDebug('guar->parallel-api->index');

  // merge app config over plugin config
  // since plugin is a peer to guar - the merge order with guar doesn't matter
